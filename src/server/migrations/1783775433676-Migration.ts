...
export class Migration1783775433676 implements MigrationInterface {
    name = 'Migration1783775433676'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`company_settings\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(190) NOT NULL DEFAULT 'AdErp', \`taxId\` varchar(32) NULL, \`logoUrl\` varchar(500) NULL, \`invoiceInfo\` text NULL, \`vatRate\` decimal(5,2) NOT NULL DEFAULT '18.00', \`currency\` varchar(8) NOT NULL DEFAULT 'AZN', \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`installations\` CHANGE \`mapUrl\` \`mapUrl\` varchar(500) NULL`);
        await queryRunner.query(`ALTER TABLE \`installations\` CHANGE \`scheduledAt\` \`scheduledAt\` datetime NULL`);
        await queryRunner.query(`ALTER TABLE \`installations\` CHANGE \`assigneeId\` \`assigneeId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`installations\` CHANGE \`teamNote\` \`teamNote\` text NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`production_tasks\` DROP FOREIGN KEY \`FK_32dfd1983de293befab641743d1\``);
        await queryRunner.query(`ALTER TABLE \`leads\` DROP FOREIGN KEY \`FK_533da3a3887638192a5dfa2c176\``);
        await queryRunner.query(`ALTER TABLE \`installations\` CHANGE \`teamNote\` \`teamNote\` text NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`installations\` CHANGE \`assigneeId\` \`assigneeId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`installations\` CHANGE \`scheduledAt\` \`scheduledAt\` datetime NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`installations\` CHANGE \`mapUrl\` \`mapUrl\` varchar(500) NULL DEFAULT 'NULL'`);
